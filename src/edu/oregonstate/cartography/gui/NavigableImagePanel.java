...
/**
 * https://today.java.net/pub/a/today/2007/03/27/navigable-image-panel.html
 */
/**
 * <p>
 ...
 * <h3>Image</h3>
 * <p>
 * An image is loaded either via a constructor:</p>
 * <pre>
 ...
 * </pre> and use <code>setZoom()</code> to change the zoom level.
 * </p>
 * <p>
 ...
 * the same way as the main image.</p>
 * <p>
 ...
 * </pre> and use <code>getImageOrigin()</code> and
...
public class NavigableImagePanel extends JPanel {
    ...
    private static final double HIGH_QUALITY_RENDERING_SCALE_THRESHOLD = 0;
    ...
    public static class ZoomDevice {
        ...
        /**
         * <p>
         * Identifies the left and right mouse buttons as the zooming
         * device.</p>
         */
    ...
    /**
     * <p>
     * Tests whether an image uses the standard RGB color space.</p>
     */
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isHighQualityRendering()) {
             ...
             */
            BufferedImage scaledImage = ImageUtils.getScaledInstance(subimage,
                    Math.min((int) (subimage.getWidth() * scale), getWidth()),
